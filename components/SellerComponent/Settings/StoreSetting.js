  ...
  return (
    <div className="flex flex-col w-full ga-y-6">
      <div className="relative h-40 w-40 rounded-xl my-5 mx-auto flex">
        {/* Image Tag */}
        {storeLogoImageURL && <Image src={storeLogoImageURL} alt="store-logo" layout="fill" objectFit="cover" className="rounded-xl" />}
        {/* Input tag */}
      ...
      <Formik initialValues={{ store_name: "", email: "", phone_number: "", website: "", about: "", states: "", cities: "" }}>
        {() => (
          <Form className="grid md:grid-cols-2 gap-3 md:w-8/12 w-11/12 mx-auto">
            <div className="">
              <MyInput name="store_name" label="Store Name" className="w-full border border-secondary-400 rounded-md h-10 p-3" />
            </div>
            <div className="">
              <MyInput name="email" label="Email" className="w-full border border-secondary-400 rounded-md h-10 p-3" />
            </div>
            <div className="">
              <MyInput name="phone_number" label="Phone Number" className="w-full border border-secondary-400 rounded-md h-10 p-3" />
            </div>
            <div className="">
              <MyInput name="website" label="Website" className="w-full border border-secondary-400 rounded-md h-10 p-3" />
            </div>
            ...
            <div className="md:col-span-2 w-full justify-between flex">
              <button onClick={() => router.back()} className="bg-red-500 h-10 px-3 py-2 text-secondary-50  font-semibold rounded-md shadow">
                Cancel
              </button>
