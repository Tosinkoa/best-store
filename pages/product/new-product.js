...
const NewProperty = () => {
  return (
    <div className="flex flex-col p-4 lg:p-8 h-full overflow-y-auto">
      ...
      <p className="my-4 font-semibold text-sm text-secondary-500 w-[75%]">
      ...
      <Tab.Group as="div" className="flex flex-col w-full my-4 mb-0">
        <Tab.List className="border-b w-full flex space-x-6">
          ...
          <Tab
            className={({ selected }) =>
              classNames(
                "py-2 text-sm font-semibold flex space-x-1 items-center",
                selected
                  ? "border-primary-800 text-primary-800  border-b-2"
                  : "text-secondary-500"
              )
        ...
        <Tab.Panels>
          ...
          <Tab.Panel className="md:h-[50vh] w-full flex bg-blue-300">
            <div>Hello there</div>
          </Tab.Panel>
        </Tab.Panels>
      </Tab.Group>
